...
public class Edge {
	...
	/**
	 * Ein neues unmarkiertes Objekt vom Typ Edge wird erstellt. Die von diesem
	 * Objekt repraesentierte Kante verbindet die Knoten pVertex und
	 * pAnotherVertex mit der Gewichtung pWeight und ist noch in keinen Graphen
	 * eingefuegt.
	 */
	...
	/**
	 * Die Anfrage liefert true, wenn die Kante mit true markiert ist, ansonsten
	 * false.
	 */
